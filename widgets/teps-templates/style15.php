...
echo '<div class="teps-postslider-15 teps-slider-widget-wrapper">';
                    ...
                    echo '<div class="teps-postslider-feature-image" style="background-image: url('.$teps_the_thumbnail_check.');">';
                        echo '<div class="d-flex width-100 height-100 align-items-end justify-content-center teps-postslider-box-alignment">';
                            echo '<div class="teps-postslider-content-info teps-slide-content '.esc_attr($animation_class).'">';
                                echo '<div class="teps-postslider-meta d-flex flex-wrap-wrap align-items-center justify-content-center">';
