...
echo '<div class="teps-postslider-3 teps-slider-widget-wrapper">';
      ...
      echo '<div class="teps-swiper-slide">';
        echo '<div class="teps-postslider-wrap">';
          echo '<div class="teps-postslider-feature-image" style="background-image: url('.$teps_the_thumbnail_check.');">';
            echo '<div class="d-flex width-100 height-100 align-items-end justify-content-end teps-postslider-box-alignment">';
