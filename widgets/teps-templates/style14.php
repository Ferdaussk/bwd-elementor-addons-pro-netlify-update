...
echo '<div class="teps-postslider-14 teps-slider-widget-wrapper">';
        ...
        if($wp_query->have_posts()):
            ...
            echo '<div class="teps-swiper-slide">';
                echo '<div class="teps-postslider-wrap">';
                    echo '<div class="d-flex justify-content-center align-items-center teps-postslider-box-alignment">';
                        echo '<div class="teps-postslider-feature-image">';
                            echo '<img src="'.$teps_the_thumbnail_check.'" alt="">';
                        ...
                        echo '</div>';
                        echo '<div class="teps-postslider-content-info">';
                            ...
                            echo '<div class="teps-postslider-meta d-flex justify-content-center flex-wrap-wrap">';
