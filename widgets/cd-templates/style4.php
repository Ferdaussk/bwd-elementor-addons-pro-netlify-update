				<div class="bwdwi-count-down-13 bwdwi-count-down-common ">
					<div class="bwdwi-count-down-wrapper <?php echo  esc_attr__($unit_dir )?>">
						...
						/>
						<div class="bwdwi-count-down-item bwdwi-count-down-item-common bwdwi-wrapper-common">
