<div class="crpt-card-area-style11 crpt-card-area-sk">
            ...
            <div class="bwd-col-lg-4 bwd-col-md-4 bwd-col-sm-6 column_number crtp_gap_c">
                <div class="crpt-card">
                    <div class="crpt-fornt-card">
                        ...
                        <div class="crpt-imgbx crpt_for_image_bg">
                            <?php if ($featured_image === 'yes') {
							    echo $image_link_enabled ? '<a href="' . get_permalink() . '">' . $product->get_image() . '</a>' : $product->get_image();
					        } ?>
                        </div>
                        <?php } else{echo '<div class="crpt-img_text">'.esc_html__('No Feature Image', BWDEB_ROOT_AUTHOR_PRO).'</div>';} ?>
                    </div>
                    <div class="crpt-back-card crpt_for_back_bg">
                        <?php if(has_post_thumbnail()){ ?>
                        ...
                        <div class="crpt-contentbx">
                                ...
                                <div class="crpt-price-box">
                                   <?php
                                    if ($product->is_type('variable')) {
                                        ...
                                        $crpt_regular_price = '<div class="crpt-regular-price"><del>' . wc_price($regular_price) . '</del></div><div class="crpt-sale-price"> ' . wc_price($sale_price) . '</div>';
                            ...
                            <div class="crpt-btn-ptype">
                                ...
                                <div class="crpt-card-button">
                                    <a href="<?php if('default' === $crtp_choose_link){ echo the_permalink(); } elseif('coustom_link' === $crtp_choose_link){ echo esc_url($settings['crtp_main_button_link']['url']); } ?>"><?php echo esc_html__($crtp_main_button); ?></a>
                                </div>
                                <?php } ?>
                            </div>
                        </div>
