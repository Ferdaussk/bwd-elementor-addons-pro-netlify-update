    ...
    foreach ($settings['bwdwpvx_lists'] as $items => $item) {
        ...
        <div class="bwdwpvx-design-11">
            ...
            <div class="bwdwpvx-item-container <?php echo esc_attr($highlightclass); ?>">
                <!-- Image & Content -->
                <div class="bwdwpvx-content-container">
                    <!-- Content -->
                    <div class="bwdwpvx-content-wrap">
                    ...
                    <!-- Price & Image -->
                    <div class="bwdwpvx-img-price-wrapper">
                        <!-- Price -->
                        <?php
