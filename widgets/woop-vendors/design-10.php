...
if($settings['bwdwpvx_product_source'] == 'custom') {
    ...
    foreach ($settings['bwdwpvx_lists'] as $items => $item) {
        ...
        <div class="bwdwpvx-design-10">
            ...
            <!-- Image & Icon -->
                <div class="bwdwpvx-img-icon-wrapper">
                    <div class="bwdwpvx-img-flip">
                    <!-- Image -->
                    <?php
                ...
                <div class="bwdwpvx-content">
                    ...
                    <!-- Price & Rate -->
                    <div class="bwdwpvx-price-rate-wrapper">
                        <!-- Currency Symbol -->
                        <?php
                        ...
                        <!-- Rating -->
                        <?php if ($item['bwdwpvx_show_customer_rating'] == 'yes') { ?>
    ...
    <div class="bwdwpvx-design-10">
        <div class="bwdwpvx-item-container bwdwpvx-woocommerce">
            ...
            if ($settings['bwdwpvx_show_image'] == 'yes') { ?>
                <div class="bwdwpvx-layout-img">
                    <div class="bwdwpvx-img-flip"><?php
