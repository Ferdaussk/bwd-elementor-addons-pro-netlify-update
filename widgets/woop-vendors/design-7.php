            ...
            <div class="bwdwpvx-item-container <?php echo esc_attr($highlightclass); ?>">
                ...
                <div class="bwdwpvx-content">
                    ...
                    if ($item['bwdwpvx_show_custom_icon'] == 'yes') { ?>
                        <span class="bwdwpvx-icon"><?php \Elementor\Icons_Manager::render_icon($item['bwdwpvx_icon'], ['aria-hidden' => 'true']); ?></span>
                    <?php } ?>
                    <!-- Title -->
                    ...
                    <?php } ?>
                    <!-- Price & Button -->
                    <div class="bwdwpvx-price-btn-wrapper">
                        <!-- Currency Symbol -->
                        <?php
