<div class="thepsttmln-timeline-twenty-two thepsttmln-16 thepsttmln-common">
        ...
        while($wp_query->have_posts()) : $wp_query->the_post();
            ...
            <div class="col-sm-6 col-md-4 <?php echo esc_attr($TL_col) ?>">
                <div class="thepsttmln-timeline-item">
                    <div class="thepsttmln-timeline-content thepsttmln-content-box thepsttmln-timeline-box-bgc-cmmn">
                        <?php 
                    // Image
                    ...
                    echo ($thepsttmln_yes_value === $thepsttmln_image_link_show)?'</a>':'';
                            echo '<div class="thepsttmln-timeline-for-content">';
