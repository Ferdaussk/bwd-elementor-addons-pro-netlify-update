<div class="thepsttmln-timeline-twenty-five thepsttmln-19 thepsttmln-common thepsttmln-scroll-show">
    ...
    if($wp_query->have_posts()) :
        while($wp_query->have_posts()) : $wp_query->the_post();
                ?>
            <div class="thepsttmln-timeline-item thepsttmln-timeline-box-bgc-cmmn">
                <div class="thepsttmln-progress-line-dot thepsttmln-shape-one-self">
                    <span class="thepsttmln-progress-line-dot-inner thepsttmln-shape-one-self"></span>
                </div>
