<div class="thepsttmln-timeline-twenty thepsttmln-14 thepsttmln-common">
        ...
        while($wp_query->have_posts()) : $wp_query->the_post();
            ...
            <div class="col-sm-6 col-md-4 <?php echo esc_attr($TL_col) ?>">
                <div class="thepsttmln-closet-shape thepsttmln-timeline-item">
                    <div class="thepsttmln-timeline-item-inner thepsttmln-shape-one-self">
                        <?php 
                        // date
                    ...
                    <div class="thepsttmln-timeline-content thepsttmln-timeline-for-content thepsttmln-content-box">
                        <?php 
                        // Image
                        ...
                        ?>
                        <div class="thepsttmln-timeline-desc">
                            <?php 
                            // ======================= Texo
                            // Cat
                            ...
                            ?>
                            <div class="thepsttmln-timeline-item-bottom-bar thepsttmln-shape-one-self">
                                <div class="thepsttmln-bottom-bar-inner"></div>
                            </div>
                        </div>
                    </div>
                </div>
