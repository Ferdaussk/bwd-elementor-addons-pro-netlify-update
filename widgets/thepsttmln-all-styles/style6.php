<div class="thepsttmln-timeline-eight thepsttmln-6 thepsttmln-common thepsttmln-progress thepsttmln-pb-bg-cmn-pseudo">
    <div class="thepsttmln-progress-helper tl-pb-helper-common"></div>
        ...
        while($wp_query->have_posts()) : $wp_query->the_post();
            ...
            <div class="thepsttmln-timeline-item">
                ...
                echo $thepsttmln_date_switch.$thepsttmln_date_title_switch;
                    ...
                    <div class="thepsttmln-bottom-circles">
                        <div class="thepsttmln-circle-left thepsttmln-circle thepsttmln-shape-one">
                            <span class="thepsttmln-circle-inner thepsttmln-shape-two"></span>
                        </div>
                        <div class="thepsttmln-circle-right thepsttmln-circle thepsttmln-shape-one">
                            <span class="thepsttmln-circle-inner thepsttmln-shape-two"></span>
                        </div>
                    </div>
                </div>
