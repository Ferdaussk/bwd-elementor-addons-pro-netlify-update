<div class="thepsttmln-timeline-twenty-one thepsttmln-15 thepsttmln-common">
    ...
    if($wp_query->have_posts()) :
        while($wp_query->have_posts()) : $wp_query->the_post();
                ...
                <div class="thepsttmln-timeline-item">
                    ...
                    <div class="thepsttmln-right-top-shape thepsttmln-shape-one-self"></div>
                    <div class="thepsttmln-right-bottom-shape thepsttmln-shape-one-self"></div>
                    <div class="thepsttmln-left-top-shape thepsttmln-shape-one-self"></div>
                    <div class="thepsttmln-left-bottom-shape thepsttmln-shape-one-self"></div>
                </div>
                <?php
        endwhile;
