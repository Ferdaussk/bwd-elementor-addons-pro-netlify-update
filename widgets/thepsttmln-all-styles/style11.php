<div class="thepsttmln-timeline-seventeen thepsttmln-11 thepsttmln-common">
        ...
        while($wp_query->have_posts()) : $wp_query->the_post();
            ...
            <div class="col-sm-6 col-md-4 <?php echo esc_attr($TL_col) ?>">
                <div class="thepsttmln-box thepsttmln-timeline-item thepsttmln-timeline-box-bgc-cmmn">
                    <div class="thepsttmln-timeline-item-top-shape thepsttmln-content-box">
                        <?php 
                // date
                ...
                echo $thepsttmln_date_switch.$thepsttmln_date_title_switch;
                    ...
                    <div class="thepsttmln-timeline-item-bottom-shape thepsttmln-shape-one-self thepsttmln-timeline-for-content">
                        <?php 
                    // Image
