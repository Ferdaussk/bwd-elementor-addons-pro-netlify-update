<div class="thepsttmln-timeline-twenty-six thepsttmln-20 thepsttmln-common thepsttmln-progress thepsttmln-pb-bg-cmn-pseudo">
    <div class="thepsttmln-progress-helper-twenty-six tl-pb-helper-common"></div>
    ...
    if($wp_query->have_posts()) :
        while($wp_query->have_posts()) : $wp_query->the_post();
                ...
                <div class="thepsttmln-timeline-item">
                    <div class="thepsttmln-timeline-item-inner thepsttmln-timeline-box-bgc-cmmn">
                        <div class="thepsttmln-timeline-item-content thepsttmln-shape-two thepsttmln-content-box thepsttmln-timeline-for-content">
                        <?php 
                // date
