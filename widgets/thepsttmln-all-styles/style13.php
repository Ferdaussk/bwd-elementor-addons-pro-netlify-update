<div class="thepsttmln-timeline-nineteen thepsttmln-13 thepsttmln-common">
    ...
    if($wp_query->have_posts()) :
        while($wp_query->have_posts()) : $wp_query->the_post();
            ...
            <div class="col-sm-6 col-md-4 <?php echo esc_attr($TL_col) ?>">
                <div class="thepsttmln-shape-two thepsttmln-box thepsttmln-timeline-item thepsttmln-timeline-box-bgc-cmmn">
                    <div class="thepsttmln-timeline-item-inner thepsttmln-shape-one-self thepsttmln-timeline-for-content">
                        <?php 
                // date
