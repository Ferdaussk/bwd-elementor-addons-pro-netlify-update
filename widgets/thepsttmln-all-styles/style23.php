<div class="thepsttmln-timeline-twenty-nine thepsttmln-23 thepsttmln-common thepsttmln-progress thepsttmln-pb-bg-cmn-pseudo">
    <div class="thepsttmln-progress-helper-twenty-nine tl-pb-helper-common"></div>
    ...
    if($wp_query->have_posts()) :
        while($wp_query->have_posts()) : $wp_query->the_post();
                ...
                echo $thepsttmln_date_switch.$thepsttmln_date_title_switch;
                        ?>
                        <div class="thepsttmln-timeline-item-content thepsttmln-shape-one thepsttmln-timeline-for-content">
                        <?php 
                    // Image
