...
class EPREL_Effective_widgets extends Widget_Base {
	...
	public function get_name() {
		return esc_html__( 'EffectivePreLoader', BWDEB_ROOT_AUTHOR_PRO );
	}

	public function get_title() {
		return esc_html__( 'Effective Pre Loader', BWDEB_ROOT_AUTHOR_PRO );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'contentSection',
			[
				'label' => esc_html__( 'Loader Content', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$repeater->add_control(
			'plcSelect',
			[
				'label' => esc_html__( 'Choose Type', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SELECT,
				'default' => 'predefined',
				'options' => [
					'predefined'  => esc_html__( 'Predefined', BWDEB_ROOT_AUTHOR_PRO ),
					'TextContent'  => esc_html__( 'Text Content', BWDEB_ROOT_AUTHOR_PRO ),
					'Image'  => esc_html__( 'Image', BWDEB_ROOT_AUTHOR_PRO ),
					'Icon'  => esc_html__( 'Icon', BWDEB_ROOT_AUTHOR_PRO ),
					'CustomCode'  => esc_html__( 'Custom Code', BWDEB_ROOT_AUTHOR_PRO ),
					'Shortcode'  => esc_html__( 'Shortcode', BWDEB_ROOT_AUTHOR_PRO ),
					'Progress'  => esc_html__( 'Progress', BWDEB_ROOT_AUTHOR_PRO ),
				],
			]
		);
		$repeater->add_control(
			'plcsPreAnimation',
			[
				'label' => esc_html__( 'Select', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SELECT,
				'default' => 'animation-1',
				'options' => [
					'animation-1'  => esc_html__( 'Animation 1', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-2'  => esc_html__( 'Animation 2', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-3'  => esc_html__( 'Animation 3', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-4'  => esc_html__( 'Animation 4', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-5'  => esc_html__( 'Animation 5', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-6'  => esc_html__( 'Animation 6', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-7'  => esc_html__( 'Animation 7', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-8'  => esc_html__( 'Animation 8', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-9'  => esc_html__( 'Animation 9', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-10'  => esc_html__( 'Animation 10', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-11'  => esc_html__( 'Animation 11', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-12'  => esc_html__( 'Animation 12', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-13'  => esc_html__( 'Animation 13', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-14'  => esc_html__( 'Animation 14', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-15'  => esc_html__( 'Animation 15', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-16'  => esc_html__( 'Animation 16', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-17'  => esc_html__( 'Animation 17', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-18'  => esc_html__( 'Animation 18', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-19'  => esc_html__( 'Animation 19', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-20'  => esc_html__( 'Animation 20', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-21'  => esc_html__( 'Animation 21', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-22'  => esc_html__( 'Animation 22', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-23'  => esc_html__( 'Animation 23', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-24'  => esc_html__( 'Animation 24', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-25'  => esc_html__( 'Animation 25', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-26'  => esc_html__( 'Animation 26', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-27'  => esc_html__( 'Animation 27', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-28'  => esc_html__( 'Animation 28', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-29'  => esc_html__( 'Animation 29', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-30'  => esc_html__( 'Animation 30', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-31'  => esc_html__( 'Animation 31', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-32'  => esc_html__( 'Animation 32', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-33'  => esc_html__( 'Animation 33', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-34'  => esc_html__( 'Animation 34', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-35'  => esc_html__( 'Animation 35', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-36'  => esc_html__( 'Animation 36', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-37'  => esc_html__( 'Animation 37', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-38'  => esc_html__( 'Animation 38', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-39'  => esc_html__( 'Animation 39', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-40'  => esc_html__( 'Animation 40', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-41'  => esc_html__( 'Animation 41', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-42'  => esc_html__( 'Animation 42', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-43'  => esc_html__( 'Animation 43', BWDEB_ROOT_AUTHOR_PRO ),
					'animation-44'  => esc_html__( 'Animation 44', BWDEB_ROOT_AUTHOR_PRO ),
				],
				'condition' => [
		...
		$repeater->add_control(
			...
			[
				...
				'default' => 'plcper1',
				'options' => [
					'plcper1'  => esc_html__( 'Layout 1', BWDEB_ROOT_AUTHOR_PRO ),
					'plcper2'  => esc_html__( 'Layout 2', BWDEB_ROOT_AUTHOR_PRO ),
					'plcper3'  => esc_html__( 'Layout 3', BWDEB_ROOT_AUTHOR_PRO ),
					'plcper4'  => esc_html__( 'Layout 4', BWDEB_ROOT_AUTHOR_PRO ),
					'plcper5'  => esc_html__( 'Layout 5', BWDEB_ROOT_AUTHOR_PRO ),
					'plcper6'  => esc_html__( 'Layout 6', BWDEB_ROOT_AUTHOR_PRO ),
				],
				'condition' => [
					'plcSelect' => 'Progress',
				],
		...
		$repeater->add_control(
			'plcper3prefix',
			[
				'label' => esc_html__( 'Prefix', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'placeholder' => esc_html__( 'Enter Prefix', BWDEB_ROOT_AUTHOR_PRO ),
				'condition' => [
					'plcSelect' => 'Progress',
		...
		$repeater->add_control(
			'plcper3postfix',
			[
				'label' => esc_html__( 'Postfix', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'placeholder' => esc_html__( 'Enter Postfix', BWDEB_ROOT_AUTHOR_PRO ),
				'condition' => [
					'plcSelect' => 'Progress',
					'plcprecentagelayout' => 'plcper3',
				],
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					'plcperpostop'  => esc_html__( 'Top', BWDEB_ROOT_AUTHOR_PRO ),
					'plcperposbottom'  => esc_html__( 'Bottom', BWDEB_ROOT_AUTHOR_PRO ),
				],
				'condition' => [
					'plcSelect' => 'Progress',
		...
		$repeater->add_control(
			'plcsImageLoader',
			[
				'label' => esc_html__( 'Loader on Image', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$repeater->add_control(
			'plcsText',
			[
				'label' => esc_html__( 'Load Text', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Loading...', BWDEB_ROOT_AUTHOR_PRO ),
				'placeholder' => esc_html__( 'Type your loading text', BWDEB_ROOT_AUTHOR_PRO ),
				'condition' => [
		...
		$repeater->add_control(
			'plcsTextLoader',
			[
				'label' => esc_html__( 'Loader on Text', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Disable', BWDEB_ROOT_AUTHOR_PRO ),
				'default' => 'no',
		...
		$repeater->add_control(
			...
			[
				...
				'rows' => 5,
				'default' => '',
				'placeholder' => esc_html__( 'Enter Your Custom Code.', BWDEB_ROOT_AUTHOR_PRO ),
				'dynamic' => [ 'active'   => true, ],
				'condition' => [
		...
		$repeater->add_control(
			...
			[
				...
				'rows' => 3,
				'default' => '',
				'placeholder' => esc_html__( 'Enter Shortcode.', BWDEB_ROOT_AUTHOR_PRO ),
				'dynamic' => [ 'active'   => true, ],
				'condition' => [
					'plcSelect' => 'Shortcode',
				],
		...
		$this->add_control(
			'preLoaderContent',
			[
				'label' => esc_html__( 'Pre Loader', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->add_control(
			'backpreloader',
			[
				'label' => esc_html__( 'PreLoad Visibility??', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Disable', BWDEB_ROOT_AUTHOR_PRO ),
				'default' => 'no',
				'description' => esc_html__('Note : It will show static preloader area just for design purpose.',BWDEB_ROOT_AUTHOR_PRO),
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			'aniLoadFirstSection',
			[
				'label' => esc_html__( 'Load First', BWDEB_ROOT_AUTHOR_PRO ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'alfSwitch',
			[
				'label' => esc_html__( 'Exclude Content', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Disable', BWDEB_ROOT_AUTHOR_PRO ),
				'default' => 'no',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'alfheader',
				'options' => [
					'alfheader'  => esc_html__( 'Header', BWDEB_ROOT_AUTHOR_PRO ),
					'alfcustom'  => esc_html__( 'Custom', BWDEB_ROOT_AUTHOR_PRO ),
				],
				'condition' => [
					'alfSwitch' => 'yes',
				],
		...
		$this->add_control(
			'alfExcludecustom',
			[
				'label' => esc_html__( 'Class', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::TEXTAREA,
				'rows' => 5,
				'default' => '',
				'placeholder' => esc_html__( '.your-class', BWDEB_ROOT_AUTHOR_PRO ),
				'dynamic' => [ 'active'   => true, ],
				'condition' => [
					'alfSwitch' => 'yes',
		...
		$this->start_controls_section(
			'pageLoadSection',
			[
				'label' => esc_html__( 'Page Transition', BWDEB_ROOT_AUTHOR_PRO ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'inTransition',
			[
				'label' => esc_html__( 'In Transition', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->add_control(
			'pageLoadTransition',
			[
				'label' => esc_html__( 'Transition', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SELECT,
				'default' => 'pageloadfadein',
				'options' => [
					'pageloadfadein'  => esc_html__( 'Fade', BWDEB_ROOT_AUTHOR_PRO ),
					'pageloadslidein'  => esc_html__( 'Slide', BWDEB_ROOT_AUTHOR_PRO ),
					'pageloadtripleswoosh'  => esc_html__( 'Triple Swoosh', BWDEB_ROOT_AUTHOR_PRO ),
					'pageloadsimple'  => esc_html__( 'Simple', BWDEB_ROOT_AUTHOR_PRO ),
					'pageloadduomove'  => esc_html__( 'Duo Move', BWDEB_ROOT_AUTHOR_PRO ),
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'top'  => esc_html__( 'Top', BWDEB_ROOT_AUTHOR_PRO ),
					'bottom'  => esc_html__( 'Bottom', BWDEB_ROOT_AUTHOR_PRO ),
					'topleft'  => esc_html__( 'Top Left', BWDEB_ROOT_AUTHOR_PRO ),
					'topright'  => esc_html__( 'Top Right', BWDEB_ROOT_AUTHOR_PRO ),
					'bottomleft'  => esc_html__( 'Bottom Left', BWDEB_ROOT_AUTHOR_PRO ),
					'bottomright'  => esc_html__( 'Bottom Right', BWDEB_ROOT_AUTHOR_PRO ),
				],
				'condition' => [
		...
		$this->add_control(
			'outTransition',
			[
				'label' => esc_html__( 'Out Transition', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Disable', BWDEB_ROOT_AUTHOR_PRO ),
				'default' => 'no',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'postloadfadeout'  => esc_html__( 'Fade', BWDEB_ROOT_AUTHOR_PRO ),
					'postloadslideout'  => esc_html__( 'Slide', BWDEB_ROOT_AUTHOR_PRO ),
					'postloadstripleswoosh'  => esc_html__( 'Triple Swoosh', BWDEB_ROOT_AUTHOR_PRO ),
					'postloadssimple'  => esc_html__( 'Simple', BWDEB_ROOT_AUTHOR_PRO ),
					'postloadsduomove'  => esc_html__( 'Duo Move', BWDEB_ROOT_AUTHOR_PRO ),
				],
				'condition' => [
					'outTransition' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Exclude Class', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::TEXTAREA,
				'rows' => 5,
				'default' => '',
				'placeholder' => esc_html__( 'Enter Exclude Class.', BWDEB_ROOT_AUTHOR_PRO ),
				'dynamic' => [ 'active'   => true, ],
				'condition' => [
					'outTransition' => 'yes',
				],
		...
		$this->start_controls_section(
			'extraOptionsSection',
			[
				'label' => esc_html__( 'Extra Options', BWDEB_ROOT_AUTHOR_PRO ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'loadtime',
			[
				'label' => esc_html__( 'Load Time', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SELECT,
				'default' => 'loadtimedefault',
				'options' => [
					'loadtimedefault'  => esc_html__( 'Default', BWDEB_ROOT_AUTHOR_PRO ),
					'loadtimemin'  => esc_html__( 'Minimum', BWDEB_ROOT_AUTHOR_PRO ),					
					'loadtimemax'  => esc_html__( 'Maximum', BWDEB_ROOT_AUTHOR_PRO ),
				],
			]
		);
		$this->add_responsive_control(
			'loadmaxtime',
			[
				'label' => esc_html__( 'Time (Second)', BWDEB_ROOT_AUTHOR_PRO ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 1,
		...
		$this->add_control(
			'imageloaderheading',
			[
				'label' => esc_html__( 'Image Loader', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_tab('il_fill',
			[
				'label' => esc_html__( 'Fill', BWDEB_ROOT_AUTHOR_PRO ),
			]
		);
		$this->add_responsive_control(
			'if_f_i_opacity',
		...
		$this->start_controls_section(
			'pr_text_styling',
			[
				'label' => esc_html__('Text Style', BWDEB_ROOT_AUTHOR_PRO),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			'textloaderheading',
			[
				'label' => esc_html__( 'Text Loader', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Predefined', BWDEB_ROOT_AUTHOR_PRO),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Gradient Color', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Disable', BWDEB_ROOT_AUTHOR_PRO ),
				'default' => 'no',				
		...
		$this->add_control(
			'progressbarcolor1',
			[
				'label' => esc_html__( 'Color 1', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'default' => '#6fc784',
				'condition' => [
		...
		$this->add_control(
			'progressbarcolor2',
			[
				'label' => esc_html__( 'Color 2', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'default' => '#6fc784d4',
				'selectors' => [
		...
		$this->add_control(
			'progressbarcolorg3',
			[
				'label' => esc_html__( 'Color 3', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'default' => '#8072fc',
				'condition' => [
					'progressbargradiantcolor' => 'yes',
		...
		$this->add_control(
			'progressbarcolorg4',
			[
				'label' => esc_html__( 'Color 4', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'default' => '#6fc784',
				'condition' => [
					'progressbargradiantcolor' => 'yes',
		...
		$this->add_control(
			'progressbarcolorg5',
			[
				'label' => esc_html__( 'Color 5', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'default' => '#f7d782',
				'condition' => [
					'progressbargradiantcolor' => 'yes',
		...
		$this->add_control(
			'progressbarcolorg6',
			[
				'label' => esc_html__( 'Color 6', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'default' => '#ff5a6e',
				'condition' => [
					'progressbargradiantcolor' => 'yes',
		...
		$this->add_control(
			'progressbarcolorg7',
			[
				'label' => esc_html__( 'Color 7', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'default' => '#8072fc',
				'selectors' => [
					'{{WRAPPER}} .eprel-loadbar,{{WRAPPER}} .percentagelayout,{{WRAPPER}} .eprel-preloader-wrap4.plcper4 .eprel-preloader-wrap4-in,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Progress Empty Color (Layout 4)', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'default' => '#ffffff7d',
				'selectors' => [
		...
		$this->add_responsive_control(
			'progressbar5size',
			[
				'label' => esc_html__( 'Progress Size (Layout 5)', BWDEB_ROOT_AUTHOR_PRO ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 1,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Progress Number', BWDEB_ROOT_AUTHOR_PRO),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Progress Layout 3', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Progress Circle', BWDEB_ROOT_AUTHOR_PRO),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'pctextemptycolor',
			[
				'label' => esc_html__( 'Empty Color', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'default' => '#ffffff36',
		...
		$this->add_control(
			'pctextheading',
			[
				'label' => esc_html__( 'Percentage Styling', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Transition Effect', BWDEB_ROOT_AUTHOR_PRO),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'pageLoadTransition' => ['pageloadtripleswoosh','pageloadsimple','pageloadduomove'],
				],
		...
		$this->add_control(
			'whole_pr_box',
			[
				'label' => esc_html__( 'Whole Background', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
				...
				if(!empty($plcSelect)){
					...
					if($plcSelect=='predefined' && !empty($item['plcsPreAnimation'])){
						if($item['plcsPreAnimation']=='animation-1'){
							...
							$preloaderSrc .='<div class="preloaderline"><div class="pen"><div class="pen_overlay"></div><div class="pen_top"></div><div class="pen_bottom"></div></div></div>';
							...
							$preloaderSrc .='<div class="predefined-style-22"><div class="itemall item-1"></div><div class="itemall item-2"></div><div class="itemall item-3"></div><div class="itemall item-4"></div></div>';
