<!-- Start Essential Pricing Plan Switcher Design 3. -->

<div class="bwdpssx-main-wrapper">
	<div class="bwdpssx-design-3">
				...
				for ($i = 1; $i <= $settings['bwdpssx_plan_count']; $i++) { ?>
					<li class="bwdpssx-plan-item bwdpssx-plan-<?php echo esc_attr($bwdpssx_plan) ?>">
						...
						for ($k = 1; $k <= $value_length; $k++) { 
							...
							<div class="bwdpssx-title-label-wrapper">
								...
								<?php } ?>
								<!-- Label. -->
								<?php if ( $settings['bwdpssx_'.$k.'_plan_label_'.$i.''] != "" ) { ?>
										<div class="bwdpssx-label">
											<div class="bwdpssx-plan-label <?php echo $settings['bwdpssx_label_design'] ?>"><?php echo esc_html( $settings['bwdpssx_'.$k.'_plan_label_'.$i.''] ); ?></div>
										</div>
									<?php } ?>
								</div>
								<div class="bwdpssx-content">
									...
									if( $settings['bwdpssx_'.$k.'_plan_description_'.$i.''] != "" ) { ?>
									...
									<?php } ?>
									<!-- Check Plan Button Text Is Not Blank. -->
									<?php if( $settings['bwdpssx_'.$k.'_button_text_'.$i.''] != "" && $settings['bwdpssx_btn_position'] == "under_feature" ) { ?>
										<div class="bwdpssx-btn-wrapper">
											<?php
												$button_link = $settings['bwdpssx_'.$k.'_plan_link_'.$i.'']['url'];
												$target = $settings['bwdpssx_'.$k.'_plan_link_'.$i.'']['is_external'] ? ' target="_blank"' : '';
...
<!-- End Essential Pricing Plan Switcher Design 3. -->