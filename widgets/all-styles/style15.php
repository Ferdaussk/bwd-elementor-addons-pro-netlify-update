<div class="woocptmln-timeline-twenty-one woocptmln-15 woocptmln-common">
        ...
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            global $product;
                ...
                <div class="woocptmln-timeline-item">
                    <div class="woocptmln-timeline-item-inner woocptmln-content-box woocptmln-timeline-box-bgc-cmmn">
                        <?php 
                        ...
                        ?>
                        <div class="woocptmln-timeline-content woocptmln-timeline-for-content">
                            <?php 
                            echo ('yes' === $woocptmln_wrapper)?'<div class="woocptmln-timeline-title" style="text-align:'.$settings['woocptmln_title_alignment'].'"><a href="'.get_the_permalink().'">'.$product->get_image().'</a></div>':$product->get_image();
                            $wooiap_title_link_check = ('yes' === $woocptmln_title_link)?'<a href="'.get_the_permalink().'">'.get_the_title().'</a>':get_the_title();?>
                            <div class="woocptmln-content-wrap">
                                <?php
                            $wooiap_title_check = '<div class="woocptmln-timeline-titlee woocptmln-timeline-desc" style="text-align:'.$settings['woocptmln_title_alignment'].'"> ' . $wooiap_title_link_check . ' </div>';
                ...
                if ( $product->is_type( 'variable' ) ) {
                    ...
                    <div class="woocptmln-right-top-shape woocptmln-shape-one-self"></div>
                    <div class="woocptmln-right-bottom-shape woocptmln-shape-one-self"></div>
                    <div class="woocptmln-left-top-shape woocptmln-shape-one-self"></div>
                    <div class="woocptmln-left-bottom-shape woocptmln-shape-one-self"></div>
                </div>
                <?php
        endwhile;
