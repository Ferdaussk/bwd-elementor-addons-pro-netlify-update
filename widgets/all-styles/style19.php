<div class="woocptmln-timeline-twenty-five woocptmln-19 woocptmln-common woocptmln-scroll-show">
    ...
    if($woocptmln_all_products->have_posts()):
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            global $product;
                ?>
            <div class="woocptmln-timeline-item woocptmln-timeline-box-bgc-cmmn">
                <div class="woocptmln-progress-line-dot woocptmln-shape-one-self">
                    <span class="woocptmln-progress-line-dot-inner woocptmln-shape-one-self"></span>
                </div>
