<div class="woocptmln-timeline-twenty-eight woocptmln-22 woocptmln-common woocptmln-pb-bg-cmn-pseudo">
    <div class="woocptmln-progress-line"></div>
    ...
    if($woocptmln_all_products->have_posts()):
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            ...
            <div class="woocptmln-closet-shape woocptmln-timeline-item">
                <div class="woocptmln-timeline-item-inner">
                    <?php 
                    ...
                    ?>
                    <div class="woocptmln-timeline-item-content woocptmln-content-box woocptmln-timeline-for-content woocptmln-timeline-box-bgc-cmmn">
                    <?php 
