<div class="woocptmln-timeline-twenty woocptmln-14 woocptmln-common">
    ...
    if($woocptmln_all_products->have_posts()):
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            ...
            <div class="col-sm-6 col-md-4 <?php echo esc_attr($TL_col) ?>">
                <div class="woocptmln-closet-shape woocptmln-timeline-item">
                    <div class="woocptmln-timeline-item-inner woocptmln-shape-one-self">
                        <?php 
                        $woocptmln_date_wrap = '<div class="woocptmln-timeline-date woocptmln-shape-one woocptmln-extra-meta woocptmln-timeline-box-bgc-cmmn">'.date( 'j M Y', strtotime( $product->get_date_created() )).'</div>';
                        $woocptmln_extra_date = ('yes' === $woocptmln_date)?$woocptmln_date_wrap:'';
                        echo $woocptmln_extra_date;
                        ?>
                    </div>
                    <div class="woocptmln-timeline-content woocptmln-timeline-for-content woocptmln-content-box">
                        <?php 
                        ...
                        ?>
                        <div class="woocptmln-timeline-desc">
                        <?php 
                    // ======================= Texo
                    // Cat
                ...
                if ( $product->is_type( 'variable' ) ) {
                    ...
                    $woocptmln_cart_button_icon = ($settings['woocptmln_cart_type'] == 'icon')?$settings['woocptmln_cart_button_icon']['value']:'';
                        ...
                        ?>
                            <div class="woocptmln-timeline-item-bottom-bar woocptmln-shape-one-self">
                                <div class="woocptmln-bottom-bar-inner"></div>
                            </div>
                        </div>
                    </div>
                </div>
