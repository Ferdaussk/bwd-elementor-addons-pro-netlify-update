<div class="woocptmln-timeline-seventeen woocptmln-11 woocptmln-common">
        ...
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            ...
            <div class="col-sm-6 col-md-4 <?php echo esc_attr($TL_col) ?>">
                <div class="woocptmln-box woocptmln-timeline-item woocptmln-timeline-box-bgc-cmmn">
                    <div class="woocptmln-timeline-item-top-shape woocptmln-content-box">
                        <?php 
                    ...
                    <div class="woocptmln-timeline-item-bottom-shape woocptmln-shape-one-self woocptmln-timeline-for-content">
                        <?php 
