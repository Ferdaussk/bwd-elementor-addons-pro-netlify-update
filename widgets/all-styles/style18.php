<div class="woocptmln-timeline-twenty-four woocptmln-18 woocptmln-common">
    ...
    if($woocptmln_all_products->have_posts()):
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            global $product;
                ?>
                <div class="woocptmln-closet-shape woocptmln-box woocptmln-timeline-item woocptmln-timeline-box-bgc-cmmn">
                    <?php 
                    ...
                    <?php 
                        echo ('yes' === $woocptmln_wrapper)?'<a href="'.get_the_permalink().'" class="woocptmln-img">'.$product->get_image().'</a>':$product->get_image();
