<div class="woocptmln-timeline-thirty TL woocptmln-24 woocptmln-common woocptmln-progress woocptmln-pb-bg-cmn-pseudo">
    <div class="woocptmln-progress-helper-thirty tl-pb-helper-common"></div>
    ...
    if($woocptmln_all_products->have_posts()):
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            ...
            <div class="woocptmln-timeline-item">
                <div class="woocptmln-timeline-item-inner woocptmln-timeline-box-bgc-cmmn">
                    ...
                    <div class="woocptmln-timeline-item-content woocptmln-timeline-for-content">
                    <?php 
                    // ======================= Texo
                    // Cat
                    ...
                    // Price
                        if ( $product->is_type( 'variable' ) ) {
                            ...
                            echo '<div class="woociap-price-range">' . wc_price( $min_price ) . ' - ' . wc_price( $max_price ) . '</div>';
                            } else {
                            echo wc_price( $variation_prices[0] );
                            }
                        } else {
