<div class="woocptmln-timeline-twenty-nine woocptmln-23 woocptmln-common woocptmln-progress woocptmln-pb-bg-cmn-pseudo">
    <div class="woocptmln-progress-helper-twenty-nine tl-pb-helper-common"></div>
        ...
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            global $product;
                ...
                <div class="woocptmln-timeline-item">
                    <div class="woocptmln-timeline-item-inner woocptmln-content-box woocptmln-shape-one woocptmln-timeline-box-bgc-cmmn">
                        <?php 
                        ...
                        ?>
                        <div class="woocptmln-timeline-item-content woocptmln-shape-one woocptmln-timeline-for-content">
                        <?php 
