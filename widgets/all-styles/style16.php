<div class="woocptmln-timeline-twenty-two woocptmln-16 woocptmln-common">
        ...
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            ...
            <div class="col-sm-6 col-md-4 <?php echo esc_attr($TL_col) ?>">
                <div class="woocptmln-timeline-item">
                    <div class="woocptmln-timeline-content woocptmln-content-box woocptmln-timeline-box-bgc-cmmn">
                        <?php 
                            echo ('yes' === $woocptmln_wrapper)?'<a href="'.get_the_permalink().'">'.$product->get_image().'</a>':$product->get_image();
                            echo '<div class="woocptmln-timeline-for-content">';
