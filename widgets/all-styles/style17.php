<div class="woocptmln-timeline-twenty-three woocptmln-17 woocptmln-common">
            ...
            <div class="col-sm-6 col-md-4 <?php echo esc_attr($TL_col) ?>">
                <div class="woocptmln-closet-shape woocptmln-timeline-item">
                    <div class="woocptmln-timeline-item-inner woocptmln-content-box woocptmln-timeline-box-bgc-cmmn">
                        <div class="woocptmln-timeline-item-content woocptmln-shape-two woocptmln-timeline-for-content">
                    <?php 
