<div class="woocptmln-timeline-eight woocptmln-6 woocptmln-common woocptmln-progress woocptmln-pb-bg-cmn-pseudo">
    <div class="woocptmln-progress-helper tl-pb-helper-common"></div>
    <div class="woocptmln-progress-line tl-pb-line-common woocptmln-pb-cmn"></div>
        ...
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            ...
            <div class="woocptmln-timeline-item">
                <div class="woocptmln-timeline-item-inner woocptmln-content-box woocptmln-timeline-box-bgc-cmmn">
                    <div class="woocptmln-timeline-header">
                    <?php 
                ...
                if ( $product->is_type( 'variable' ) ) {
                    ...
                    <div class="woocptmln-bottom-circles">
                        <div class="woocptmln-circle-left woocptmln-circle woocptmln-shape-one">
                            <span class="woocptmln-circle-inner woocptmln-shape-two"></span>
                        </div>
                        <div class="woocptmln-circle-right woocptmln-circle woocptmln-shape-one">
                            <span class="woocptmln-circle-inner woocptmln-shape-two"></span>
                        </div>
                    </div>
                </div>
