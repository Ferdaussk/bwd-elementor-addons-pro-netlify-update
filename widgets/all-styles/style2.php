<div class="woocptmln-timeline-three woocptmln-2 woocptmln-common woocptmln-scroll-show">
    ...
    if($woocptmln_all_products->have_posts()):
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            global $product;
            ?>
            <div class="woocptmln-box woocptmln-timeline-item woocptmln-timeline-for-content woocptmln-timeline-box-bgc-cmmn">
                <?php 
                ...
                // =======================
                echo ('yes' === $woocptmln_wrapper)?'<a href="'.get_the_permalink().'" class="woocptmln-timeline-img">'.$product->get_image().'</a>':'<div class="woocptmln-timeline-img">'.$product->get_image().'</div>';
                ?>
                <div class="woocptmln-timeline-item-content">
                    <?php 
                    // Description
