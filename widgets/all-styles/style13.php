<div class="woocptmln-timeline-nineteen woocptmln-13 woocptmln-common">
    ...
    if($woocptmln_all_products->have_posts()):
        while ( $woocptmln_all_products->have_posts() ) : $woocptmln_all_products->the_post();
            ...
            <div class="col-sm-6 col-md-4 <?php echo esc_attr($TL_col) ?>">
                <div class="woocptmln-shape-two woocptmln-box woocptmln-timeline-item woocptmln-timeline-box-bgc-cmmn">
                    <div class="woocptmln-timeline-item-inner woocptmln-shape-one-self woocptmln-timeline-for-content">
                        <?php 
