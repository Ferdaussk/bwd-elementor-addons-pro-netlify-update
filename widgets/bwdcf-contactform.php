...
class bwdcfContactForm extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact Form 7 Styler', BWDEB_ROOT_AUTHOR_PRO );
	}

	public function get_icon() {
		return 'contact-form bwdeb-elementor-bundle';
	}
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_tab', [
                'label' => esc_html__( 'Contact Form 7', BWDEB_ROOT_AUTHOR_PRO ),
            ]
        );
        if(! bwdcf7_require_plugin_check()):
			...
			$this->add_control(
				'bwdcf_contact_form7',
				[
					'label' =>esc_html__( 'Choose Contact Form', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->add_control(
			...
			[
				'label' => __('Form Title', BWDEB_ROOT_AUTHOR_PRO),
		...
		$this->add_control(
			...
			[
				'label' => __('Form Description', BWDEB_ROOT_AUTHOR_PRO),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('On', BWDEB_ROOT_AUTHOR_PRO),
				'label_off' => __('Off', BWDEB_ROOT_AUTHOR_PRO),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Form Column', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'colone',
				'options' => [
					'colone' => esc_html__( 'Column One', BWDEB_ROOT_AUTHOR_PRO ),
					'coltwo' => esc_html__( 'Column Two', BWDEB_ROOT_AUTHOR_PRO ),
					'colthree'  => esc_html__( 'Coloumn Three', BWDEB_ROOT_AUTHOR_PRO ),
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Type Text Width', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'full' => esc_html__( 'Full Width', BWDEB_ROOT_AUTHOR_PRO ),
					'half' => esc_html__( 'Half Width', BWDEB_ROOT_AUTHOR_PRO ),
					'onethird'  => esc_html__( 'One Third', BWDEB_ROOT_AUTHOR_PRO ),
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Type Email Width', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Hide', BWDEB_ROOT_AUTHOR_PRO ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Type URL Width', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Hide', BWDEB_ROOT_AUTHOR_PRO ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Type TEL Width', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Hide', BWDEB_ROOT_AUTHOR_PRO ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Type Number Width', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Hide', BWDEB_ROOT_AUTHOR_PRO ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Type Date Width', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Hide', BWDEB_ROOT_AUTHOR_PRO ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Type Select Width', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Hide', BWDEB_ROOT_AUTHOR_PRO ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Input Type Textarea Width', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Hide', BWDEB_ROOT_AUTHOR_PRO ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Container', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Form Alignment', BWDEB_ROOT_AUTHOR_PRO),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Form Width', BWDEB_ROOT_AUTHOR_PRO),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Form Title', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Form Description', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Input', BWDEB_ROOT_AUTHOR_PRO ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Field Style', BWDEB_ROOT_AUTHOR_PRO ),
				'type'  => Controls_Manager::SELECT,
				'default' => 'box',
				'options' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Underline Width', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Underline Color', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Textarea', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Select Option', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Option Color', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Option Background Color', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Cursor Color', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Focus', BWDEB_ROOT_AUTHOR_PRO ),
            ]
		);
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Input Default Value', BWDEB_ROOT_AUTHOR_PRO ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Placeholder', BWDEB_ROOT_AUTHOR_PRO ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Placeholder Color', BWDEB_ROOT_AUTHOR_PRO ),
                'type' => Controls_Manager::COLOR,
                'default' => '#000000',
                'selectors' => [
      ...
      $this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Radio Button', BWDEB_ROOT_AUTHOR_PRO ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'block' => esc_html__( 'Vertical ', BWDEB_ROOT_AUTHOR_PRO ),
				],
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Inner Checked Size', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Radio Button Color', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Radio Checked Color', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Checkbox', BWDEB_ROOT_AUTHOR_PRO ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Inner Arrow Size', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 1,
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'File Upload', BWDEB_ROOT_AUTHOR_PRO ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Margin Top', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Use Height Width', BWDEB_ROOT_AUTHOR_PRO ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', BWDEB_ROOT_AUTHOR_PRO ),
				'label_off' => esc_html__( 'Hide', BWDEB_ROOT_AUTHOR_PRO ),
				'return_value' => 'yes',
