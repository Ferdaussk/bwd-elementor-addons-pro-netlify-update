...
class GRSTBCMBreadcrumBWidget extends Widget_Base{
    ...
    public function get_name(){
        return esc_html__('GreatestBreadcrumb', BWDEB_ROOT_AUTHOR_PRO);
    }
    public function get_title(){
        return esc_html__('Greatest Breadcrumb', BWDEB_ROOT_AUTHOR_PRO);
    }
	...
	protected function register_controls() {
		...
		$this->add_control(
			'show_home',
			array(
				'label'        => esc_html__( 'Show Home', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->add_control(
			'home_text',
			array(
				'label'     => esc_html__( 'Home Text', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->add_control(
			'select_home_icon',
			array(
				'label'            => esc_html__( 'Home Icon', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->start_controls_section(
			'section_separator',
			array(
				'label'     => esc_html__( 'Separate Indicator', BWDEB_ROOT_AUTHOR_PRO ),
			)
		);
		...
		$this->add_control(
			'separator_type',
			array(
				'label'     => esc_html__( 'Separate Type', BWDEB_ROOT_AUTHOR_PRO ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'icon',
				'options'   => array(
		...
		$this->add_control(
			'separator_text',
			array(
				'label'     => esc_html__( 'Separator', BWDEB_ROOT_AUTHOR_PRO ),
				'type'      => Controls_Manager::TEXT,
		...
		$this->add_control(
			...
			array(
				'label'            => esc_html__( 'Indicator', BWDEB_ROOT_AUTHOR_PRO ),
				'type'             => Controls_Manager::ICONS,
				'label_block'      => false,
				'skin'             => 'inline',
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Items Style', BWDEB_ROOT_AUTHOR_PRO ),
		...
		$this->start_controls_section(
			...
			array(
				'label'     => esc_html__( 'Current', BWDEB_ROOT_AUTHOR_PRO ),
				'tab'       => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section('grstbcmb_breadcrumbs_grstbcmb_structured_data',
			[
				'label' => __('Google Structured Data Schema', BWDEB_ROOT_AUTHOR_PRO),
		...
		$this->add_control(
			'grstbcmb_enable_google_schema',
				[
					'label' => esc_html__('Enable Schema?', BWDEB_ROOT_AUTHOR_PRO),
					'type' => Controls_Manager::SELECT,
					'options'  => [
						'yes'  => esc_html__('Yes', 'Show Child Pages', BWDEB_ROOT_AUTHOR_PRO),
						'no' => esc_html__('No', 'Show Child Pages', BWDEB_ROOT_AUTHOR_PRO),
					],
					'default' => 'yes',
				]
		);
	...
	protected function render() {
		...
		$name_herE = BWDEB_ROOT_AUTHOR_PRO;
		if ( $name_herE == true ) {
...
// has an code for post type string showed here (ferdaussk)
				...
				echo '<li ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-year' ) ) . '><a ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-year-crumb' ) ) . '>' . wp_kses_post( get_the_time( 'Y' ) ) . ' ' . esc_attr__( 'Archives', BWDEB_ROOT_AUTHOR_PRO ) . '</a></li>';

				$this->render_separator();

				echo '<li ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-month' ) ) . '><a ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-month-crumb' ) ) . '>' . wp_kses_post( get_the_time( 'M' ) ) . ' ' . esc_attr__( 'Archives', BWDEB_ROOT_AUTHOR_PRO ) . '</a></li>';

				$this->render_separator();

				echo '<li ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-day' ) ) . '><strong ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-day-crumb' ) ) . '> ' . wp_kses_post( get_the_time( 'jS' ) ) . ' ' . wp_kses_post( get_the_time( 'M' ) ) . ' ' . esc_attr__( 'Archives', BWDEB_ROOT_AUTHOR_PRO ) . '</strong></li>';
				...
				echo '<li ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-year' ) ) . '><strong ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-year-crumb' ) ) . '>' . wp_kses_post( get_the_time( 'Y' ) ) . ' ' . esc_attr__( 'Archives', BWDEB_ROOT_AUTHOR_PRO ) . '</strong></li>';

				$this->render_separator();

				echo '<li ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-month' ) ) . '><strong ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-month-crumb' ) ) . '>' . wp_kses_post( get_the_time( 'M' ) ) . ' ' . esc_attr__( 'Archives', BWDEB_ROOT_AUTHOR_PRO ) . '</strong></li>';
				...
				echo '<li ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-author' ) ) . '><strong ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-author-bread' ) ) . '>' . esc_attr__( 'Author:', BWDEB_ROOT_AUTHOR_PRO ) . ' ' . esc_attr( $userdata->display_name ) . '</strong></li>';
				...
				$this->add_render_attribute(
					array(
						...
						'breadcrumbs-item-paged-bread' => array(
							...
							'title' => esc_html__( 'Page', BWDEB_ROOT_AUTHOR_PRO ) . ' ' . get_query_var( 'paged' ),
						),
					)
				);
				echo '<li id="hksdh_ferdaus" ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-paged' ) ) . '><strong ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-paged-bread' ) ) . '>' . esc_attr__( 'Page', BWDEB_ROOT_AUTHOR_PRO ) . ' ' . wp_kses_post( get_query_var( 'paged' ) ) . '</strong></li>';
				...
				$this->add_render_attribute(
					array(
						...
						'breadcrumbs-item-search-crumb' => array(
							...
							'title' => esc_html__( 'Search results for:', BWDEB_ROOT_AUTHOR_PRO ) . ' ' . get_search_query(),
						),
					)
				);
				echo '<li ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-search' ) ) . '><strong ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-search-crumb' ) ) . '>' . esc_attr__( 'Search results for:', BWDEB_ROOT_AUTHOR_PRO ) . ' ' . get_search_query() . '</strong></li>';
				...
				// 404 page
				echo '<li ' . wp_kses_post( $this->get_render_attribute_string( 'breadcrumbs-item-error' ) ) . '>' . esc_attr__( 'Error 404', BWDEB_ROOT_AUTHOR_PRO ) . '</li>';
			}
			echo '</ul>';
		}
	}
