<div class="woofpt-card-area-11 woofpt-card-area-sk">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 column_number woofpt_gap_c">
                <div class="woofpt-card">
                    ...
                    <?php $woofpt_sale_nots = $product->get_sale_price() == true?'<div class="woofpt_sale_notice">'.esc_html__($woofpt_sale_dis_text).'</div>':''; echo $woofpt_sale_dis == 'yes'?$woofpt_sale_nots:'';
                        ...
                        <div class="woofpt-imgbx woofpt_for_image_bg">
                    ...
                    <div class="woofpt-back-card woofpt_for_back_bg">
                        ...
                        <div class="woofpt-card-icon">
                            <?php echo '<a href="' . $product->add_to_cart_url() . '"><i class="'.esc_attr($settings['woofpt_cart_button_icon']['value']).'"></i></a>'; ?>
                        </div>
                        <?php } ?>
                        <div class="woofpt-contentbx">
                            ...
                            <div class="woofpt-btn-ptype <?php echo esc_attr($woofpt_cont_align); ?>">
