            ...
            <div class="col-lg-4 col-md-4 col-sm-6 column_number woofpt_gap_c">
                <div class="woofpt-card">
                    ...
                    <div class="woofpt-contentbx">
                        <div class="woofpt-sub-content">
                            <div class="woofpt-card-hedi-box">
                                <div class="woofpt-card-title <?php echo esc_attr($woofpt_cont_align); ?>">
