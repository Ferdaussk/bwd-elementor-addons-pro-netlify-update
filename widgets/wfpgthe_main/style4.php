            ...
            <div class="col-lg-4 col-md-4 col-sm-6 column_number woofpt_gap_c">
                <div class="woofpt-card">
                    <div class="woofpt-imgbx">
                        ...
                        echo '<a href="'.get_permalink().'">' . $product->get_image().'</a>';
					    } else{echo '<div class="woofpt-img_text">'.esc_html__('No Feature Image', 'creative-products').'</div>';} ?>
