<div class="woofpt-card-area-8">
    <div class="container-fluid">
        <div class="row <?php echo esc_attr($woofpt_align .' '. $woofpt_products_column_gap); ?>">
        <?php
        $woofpt_all_products = new WP_Query( $woofpt_args ); if($woofpt_all_products->have_posts()):
        while ( $woofpt_all_products->have_posts() ) : $woofpt_all_products->the_post();
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 column_number woofpt_gap_c">
                <div class="woofpt-card">
                    <div class="woofpt-upper-item woofpt_for_image_bg">
                        ...
                        <?php } else{echo '<div class="woofpt-img_text">'.esc_html__('No Feature Image', 'creative-products').'</div>';} ?>
                        <?php if('yes' === $settings['woofpt_cart_btn']){ ?>
                        <div class="woofpt-card-icon">
                            <div class="woofpt-love"><?php echo '<a href="' . $product->add_to_cart_url() . '"><i class="'.esc_attr($settings['woofpt_cart_button_icon']['value']).'"></i></a>'; ?></div>
                        </div>
                        <?php } ?>
                    </div>
                    <div class="woofpt-contentbx">
                        <?php if('yes' === $settings['woofpt_title']){ ?>
                        <div class="woofpt-card-heading <?php echo esc_attr($woofpt_cont_align); ?>"><a href="<?php echo get_permalink(); ?>"><?php echo get_the_title(); ?></a></div>
                        <?php } ?>
                        <?php if('yes' === $settings['woofpt_price']){ ?>
                        <div class="woofpt-price-box <?php echo esc_attr($woofpt_cont_align); ?>">
                            <?php 
                        ...
                        <div class="woofpt-product-type <?php echo esc_attr($woofpt_cont_align); ?>">
                        ...
                        <div class="woofpt-card-button <?php echo esc_attr($woofpt_cont_align); ?>">
