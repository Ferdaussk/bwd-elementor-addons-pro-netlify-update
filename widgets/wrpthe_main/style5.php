<div class="woocrp_related-product_4 woocrp_related-product_5 woocrp-slider-common <?php echo esc_attr($settings['woocrp_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['woocrp-product-custom-id'] ); ?>">
