<div class="woocrp_related-product_8 woocrp-slider-common <?php echo esc_attr($settings['woocrp_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['woocrp-product-custom-id'] ); ?>">
        ...
        <div class="woocrp-item">
            <div class="woocrp_relproduct-wrap">
                <div class="woocrp_relproduct-img">
                    ...
                    <a class="woocrp_anchor" href="<?php the_permalink( $wooc_products ); ?>"></a><?php } ?>
					...
					<?php } ?>
                    <div class="woocrp_overlay-content">
