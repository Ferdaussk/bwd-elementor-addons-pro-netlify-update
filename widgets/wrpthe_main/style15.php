<div class="woocrp_related-product_15 woocrp-slider-common <?php echo esc_attr($settings['woocrp_dots_type_style']); ?>" id="<?php echo esc_attr( $settings['woocrp-product-custom-id'] ); ?>">
        ...
        <div class="woocrp-item">
            <div class="woocrp_relproduct-wrap">
                <div class="woocrp_relproduct-img">
                    <?php if($woocrp_image === 'yes'){ ?><a href="<?php the_permalink( $wooc_products ); ?>"><img src="<?php echo esc_url( $thumbnail ); ?>" alt="<?php echo esc_attr( $name_one_fsk01->get_name() ); ?>"/></a><?php } ?>
                ...
                <div class="woocrp_more-content <?php echo esc_html__($woocrp_cont_align); ?>">
