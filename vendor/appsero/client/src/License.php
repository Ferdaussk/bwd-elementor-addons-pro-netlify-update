...
class License {
    ...
    public function menu_output() {
        ...
        <div class="wrap appsero-license-settings-wrapper">
            <h1><?php _e('BWD License Settings'); ?></h1>

            <div class="pro-go-plugin-from-license">
                <a href="<?php echo admin_url( 'admin.php?page=bwdeb-plugin-main-menu' );?>">
                    <span><?php _e('Go BWD Plugin Dashboard'); ?></span>
                </a>
            </div>
            <?php
