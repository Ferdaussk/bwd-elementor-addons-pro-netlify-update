		...
		$(document).ready(function(){
			...
			if($('body').hasClass('effective-pre-loader-preloader')){
				if(post_load_exclude_class != undefined && post_load_exclude_class !=''){
					$(document).on("click", post_load_exclude_class, function(eWas) {
						if ((eWas.shiftKey || eWas.ctrlKey || eWas.metaKey || '_blank' == $.trim($(this).attr('target')))) {
							return;
						}					
