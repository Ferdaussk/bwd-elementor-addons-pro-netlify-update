'use strict';
var defaultValueForEmitter = '';
var defaultValueForWheel = '';
if (typeof require !== 'undefined') {
  // var Ferdaus = require('');
  var Emitter = require('component-emitter');
  var wheel = require('eventwheel');
} else {
  // Provide default values if require is not defined (for browser environment)
  // var Ferdaus = defaultValueForFerdaus;
  var Emitter = defaultValueForEmitter;
  var wheel = defaultValueForWheel;
}
